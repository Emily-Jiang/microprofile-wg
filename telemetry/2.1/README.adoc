...
== Release Review
The Specification Committee Ballot concluded successfully on xxx with the results documented in the https://www.eclipse.org/lists/microprofile-wg/msg02874.html[microprofile-wg mailing list]